...
public class ApplicantResumeDTO {
	...
	public ApplicantResumeDTO(int apply_seq, String apply_status, int job_post_num, String member_id, int resume_num,
			String job_title, String company_name, String post_status, String resume_title, String preferred_job,
			String working_condition, String career, String career_write, String introduction, Timestamp resume_date,
