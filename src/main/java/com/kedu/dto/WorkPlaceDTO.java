...
public class WorkPlaceDTO {
	...
	public WorkPlaceDTO(int seq, String id, String name, int pay_per_hour, String pay_type, String pay_cycle,
			...
			String work_start_time, String work_end_time, Timestamp workplace_date) {
		super();
		this.seq = seq;
		this.id = id;
		this.name = name;
	...
	public Timestamp getWorkplace_date() {
	...
	public void setWorkplace_date(Timestamp workplace_date) {
		this.workplace_date = workplace_date;
	}
