    ...
    <div class="page">
        ...
        <section class="post-list">
				...
				<c:forEach var="a" items="${allList }">
	                ...
	                onclick="location.href='/mypage/view?seq=${a.seq}&view_count=${a.view_count }'">
	                    <div class="post-top">
	                            ...
	                            <div class="post-meta""><fmt:formatDate value="${a.write_date}" pattern="yyyy-MM-dd HH:mm"/>       
	                            </div>          
	                    </div>
	                    ...
	                    <div class="post-info-row">
	                        ...
	                        <span><i class="fa-regular fa-comment-dots"></i> 댓글 ${a.reply_count }</span>
	                    </div>
	                </div>
				</c:forEach>
            </div>
            ...
            <div class="empty-box" id="emptyBox">
                <i class="fa-regular fa-file-lines fa-2x" style="margin-bottom: 12px;"></i>
                <div>검색 결과가 없어요.</div>
            </div>
        </section>
