...
<div class="community-container">
    ...
    <div class="write-box">
        ...
        <form action="/qna/update" method="post" id = "frm" enctype="multipart/form-data">
        <input type="hidden" value ="${dto.seq }" name ="seq">
            ...
            <!-- 버튼 영역 -->
            <div class="btn-group">
                <button type="button" class="cancel-btn" onclick="location.href='/qna/detail?seq=${dto.seq}'">취소</button>
